...
st.markdown("<h1 style='color: #D2691E; font-size: 40px; text-align: center;'>WEATHER PREDICTION APP</h1>", unsafe_allow_html=True)
st.markdown("<h6 style = 'top_margin: 0rem;color: #008B8B'>Built by Chinedu Emelike</h6>", unsafe_allow_html = True)
st.image('pic 3.png', width=500)


st.subheader("Ask Your Weather Related Questions, Odogwu Will Give A Reply")

if st.sidebar.button('Read Usage Instruction'):
    st.sidebar.markdown("<h4 style = 'text-decoration: underline;  color: #F2675E'>Read The Usage Instructions</h4> ", unsafe_allow_html = True)
